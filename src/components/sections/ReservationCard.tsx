...
export function ReservationCard() {
  ...
  if (success) {
    return (
      <div className="glass p-8 max-w-md mx-auto text-center animate-pulse-glow">
  ...
  return (
    ...
    >
      <div className="flip-card-inner relative w-full min-h-[500px]">
        {/* Front Side */}
        <div className="flip-card-front absolute inset-0 glass p-8 flex flex-col items-center justify-center">
          <div className="mb-8">
            <img
              src="/logo.svg"
              alt="Bethel Bellini"
              className="w-48 h-auto mx-auto hover:scale-110 transition-transform duration-500"
            />
          </div>
          ...
          <a
            ...
            className="mt-4 text-bethel-cyan hover:text-white transition-colors flex items-center gap-2"
          >
        ...
        {/* Back Side - Form */}
        <div className="flip-card-back absolute inset-0 glass p-8">
          <button
